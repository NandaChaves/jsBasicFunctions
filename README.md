...
🚀 Funcionalidades
O projeto demonstra visualmente o uso de:
Adição de Elementos: push(), unshift(), splice().
Transformação e Ordenação: sort(), reverse(), join(), toString().
Busca e Acesso: indexOf(), copyWithin(), acesso por índice [0].
Estrutura de Dados Map: set(), get(), keys(), values() e forEach().

🛠️ Tecnologias Utilizadas
HTML5 / CSS3 (com Bootstrap 4.3.1 para o layout).
JavaScript (ES6+) para a lógica de manipulação de dados.
jQuery para manipulação de eventos de clique.

📖 Como usar
Abra o arquivo index.html no seu navegador.
Digite o nome de um café no campo de entrada (ex: "Cappuccino").
Clique em Add.
